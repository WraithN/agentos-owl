...
import { DEFAULT_SLICE_RULES } from '../constants.js';
...
const MOCK_DOCS: KnowledgeDoc[] = [
  { id: 'd1', name: 'OwlOS 架构设计文档.pdf',   type: 'pdf',  size: '2.3 MB',  status: 'ready',      chunks: 28 },
...
const MOCK_CHUNKS: DocChunk[] = [
  { id: 'c1', tokens: 312, content: '## 系统架构概述\n\nOwlOS 采用意图驱动的多层架构设计，核心由三个层次组成：感知层（Intent Layer）、调度层（Orchestration Layer）和执行层（Execution Layer）。感知层负责理解用户自然语言输入，通过大语言模型提取任务意图和参数；调度层基于意图复杂度自动选择单聊、群聊或自动化模式；执行层包含具体的 Agent 实现和工具集成。' },
          ...
          <div className="flex-1 overflow-y-auto min-h-0 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="glass rounded-2xl p-5 h-full">
                ...
                {[
                  { text: '上传 OwlOS 架构设计文档.pdf', time: '10分钟前', color: 'text-cyan-400' },
