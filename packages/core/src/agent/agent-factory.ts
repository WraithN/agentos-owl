...
import { BaseAgentRuntime, type ElderAgentRuntime, type SentinelAgentRuntime, type WorkerAgentRuntime } from "./agent-runtime.js";
...
export type RecruitHandler = (elder: ElderAgentRuntime, input: RecruitInput) => Promise<unknown>;
...
class ElderAgent extends BaseAgentRuntime implements ElderAgentRuntime {
  ...
  recruit(input: RecruitInput): Promise<unknown> {
