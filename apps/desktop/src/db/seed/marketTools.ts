...
export function seedMarketTools(db: Database.Database): void {
  ...
  const tools: MarketTool[] = [
    ...
    { id: "tool-4", name: "图表生成", description: "根据数据自动生成多种可视化图表...", category: "数据分析", toolType: "skill", icon: "BarChart3", iconBg: "from-amber-500/30 to-orange-500/30", version: "1.2.0", developer: "OwlOS 官方", rating: 4.6, installs: 54100, tags: ["已安装", "官方"], installed: true, needsApiKey: false, official: true, createdAt: daysAgo(90), updatedAt: daysAgo(10) },
    ...
    { id: "tool-6", name: "PDF 解析器", description: "高精度解析 PDF 文档内容...", category: "文档", toolType: "skill", icon: "FileText", iconBg: "from-red-500/30 to-rose-500/30", version: "1.8.0", developer: "DocAI Labs", rating: 4.4, installs: 31800, tags: [], installed: false, needsApiKey: false, official: false, createdAt: daysAgo(90), updatedAt: daysAgo(10) },
    ...
    { id: "tool-8", name: "邮件发送", description: "使用 SMTP 或 SendGrid 发送邮件...", category: "通信", toolType: "skill", icon: "Mail", iconBg: "from-teal-500/30 to-cyan-500/30", version: "1.1.2", developer: "MailForge", rating: 4.3, installs: 22400, tags: ["需 API Key"], installed: false, needsApiKey: true, official: false, createdAt: daysAgo(90), updatedAt: daysAgo(10) },
    ...
    { id: "tool-11", name: "知识召回", description: "从本地知识库中语义检索相关片段...", category: "搜索", toolType: "skill", icon: "Search", iconBg: "from-cyan-500/30 to-emerald-500/30", version: "2.0.0", developer: "OwlOS 官方", rating: 4.8, installs: 15600, tags: ["官方"], installed: false, needsApiKey: false, official: true, createdAt: daysAgo(90), updatedAt: daysAgo(10) },
  ];
